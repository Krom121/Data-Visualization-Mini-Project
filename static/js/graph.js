...
function show_average_salaries(ndx){
 ...
 function show_rank_distribution(ndx) {
       ...
       var dim = ndx.dimension(dc.pluck("sex")); var profByGender = rankByGender(dim, "Prof");    
       var asstProfByGender = rankByGender(dim, "AsstProf");    var assocProfByGender = rankByGender(dim, "AssocProf");
// stacked
